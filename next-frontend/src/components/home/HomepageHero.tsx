...
export function HomepageHero() {
    ...
    return (
        <div className="absolute inset-0 -z-10 bg-black">
            ...
            <div
                className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white select-none pointer-events-none transition-opacity duration-700"
