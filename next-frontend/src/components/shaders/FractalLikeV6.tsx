...
import { rotate, vec2, sin, cos, mul, pow, div, add, mix, mod, round, abs, color, time, positionLocal, vec3, Fn, uv, uniform, screenSize, Loop, float, fract, step } from 'three/tsl';
...
export function FractalLikeV6(props: any) {
